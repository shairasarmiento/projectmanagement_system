...
<form role="form" method="POST" action="redirect/create_project.php">
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="proj_code" class="form-control" id="" value="" >
      ...
      <div class="row">
        <div class="col-md-6">
          <button type="submit" name="submit" value="Insert" class="text-center btn btn-block btn-primary">Submit</button>
        </div>

        <div class="col-md-6">
              <button type="cancel" class="text-center btn btn-block btn-primary">Cancel</button>
        </div>
